...
export const faqsIntro = {
  ...
  subheading:
    "Got more questions? We’ve got the answers below—or get in touch for a personalised response.",
};
...
export const faqs: FAQ[] = [
  ...
  { q: "Do you offer free quotes?", a: "Yes, we offer free, no-obligation quotes. Our team will visit your property, assess your needs, and provide a detailed breakdown." },
  {
